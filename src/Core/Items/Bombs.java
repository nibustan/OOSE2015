...
<<<<<<< HEAD
	 ...
	 * @param blastRadius
	 *            = How many tilelenghts the bomb will create fire in each
	 *            direction when it explodes.
=======
	 * @param x = the x position of the bomb.
	 * @param y = the y position of the bomb.
	 * @param blastRadius = How many tilelengths the bomb will create 
...
>>>>>>> origin/master
	...
	/**
	 * Keeps checking the timers on the active bombs, removes fire and checks if
	 * active bombs on the map should explode early due to fireblasts.
	 */
<<<<<<< HEAD
	public void update() {
		timerBomb();
...
>>>>>>> origin/master
	...
	public void timerBomb(Player p) {
...
=======
	public void explodeBomb(Player p){		
>>>>>>> origin/master
		hitWallRight = false;
		hitWallLeft = false;
		hitWallUp = false;
...
<<<<<<< HEAD
		...
		if (PlayState.map.getTileId(x + 1, y, PlayState.boxLayer) == 111) {
		...
		} else if (PlayState.map.getTileId(x + 1, y, PlayState.wallLayer) == 18
				|| PlayState.map.getTileId(x + 1, y, PlayState.wallLayer) == 98) {
			hitWallRight = true;
		} else if (PlayState.map.getTileId(x + 2, y, PlayState.boxLayer) == 111
				&& blastRadius >= 2 && hitWallRight != true
				&& hitBoxRight != true) {
			...
			hitWallRight = true;
		} else if (PlayState.map.getTileId(x + 3, y, PlayState.boxLayer) == 111
				&& blastRadius >= 3 && hitWallRight != true
				&& hitBoxRight != true) {
			...
			hitWallRight = true;
		} else if (PlayState.map.getTileId(x + 4, y, PlayState.boxLayer) == 111
				&& blastRadius == 4 && hitWallRight != true
				&& hitBoxRight != true) {
		...
		if (PlayState.map.getTileId(x + 1, y, PlayState.wallLayer) == 18
				|| PlayState.map.getTileId(x + 1, y, PlayState.wallLayer) == 98) {
			hitWallRight1 = true;
		}
...
=======
			...
			if (PlayState.map.getTileId(x + 1, y, PlayState.boxLayer) == 111) {
				...
				PlayState.map.setTileId(x + 1, y, PlayState.fireLayerH, 133);
				hitBoxRight = true;
				Core.Items.Item.itemDrop(x + 1,y, p.bombLength, p.bombsActive);
			}
				...
				PlayState.map.setTileId(x + 2, y, PlayState.fireLayerH, 133);
				hitBoxRight = true;
				Core.Items.Item.itemDrop(x + 2,y, p.bombLength, p.bombsActive);
			}
			else if(PlayState.map.getTileId(x + 2, y, PlayState.wallLayer) == 98){
				hitWallRight = true;
			}
				...
				PlayState.map.setTileId(x + 3, y, PlayState.fireLayerH, 133);
				hitBoxRight = true;
				Core.Items.Item.itemDrop(x + 3,y, p.bombLength, p.bombsActive);
			}
			else if(PlayState.map.getTileId(x + 3, y, PlayState.wallLayer) == 98){
				hitWallRight = true;
			}
				...
				PlayState.map.setTileId(x + 3, y, PlayState.fireLayerH, 133);
				PlayState.map.setTileId(x + 4, y, PlayState.fireLayerH, 133);
				Core.Items.Item.itemDrop(x + 4,y, p.bombLength, p.bombsActive);
			}
...
>>>>>>> origin/master
			...
			if (PlayState.map.getTileId(x + 2, y, PlayState.boxLayer) == 0
					&& blastRadius >= 2 && hitWallRight1 != true) {
				PlayState.map.setTileId(x + 1, y, PlayState.fireLayerH, 133);
<<<<<<< HEAD
				PlayState.map.setTileId(x + 2, y, PlayState.fireLayerH, 133);
				Core.Items.Item.itemDrop(x + 2, y);
				...
				if (PlayState.map.getTileId(x + 3, y, PlayState.boxLayer) == 0
						&& blastRadius >= 3 && hitWallRight1 != true) {
					PlayState.map
							.setTileId(x + 1, y, PlayState.fireLayerH, 133);
					PlayState.map
							.setTileId(x + 2, y, PlayState.fireLayerH, 133);
					PlayState.map
							.setTileId(x + 3, y, PlayState.fireLayerH, 133);
					Core.Items.Item.itemDrop(x + 3, y);
					if (PlayState.map.getTileId(x + 4, y, PlayState.wallLayer) == 98) {
						hitWallRight1 = true;
					}

					if (PlayState.map.getTileId(x + 4, y, PlayState.boxLayer) == 0
							&& blastRadius == 4 && hitWallRight1 != true) {
						PlayState.map.setTileId(x + 1, y, PlayState.fireLayerH,
								133);
						PlayState.map.setTileId(x + 2, y, PlayState.fireLayerH,
								133);
						PlayState.map.setTileId(x + 3, y, PlayState.fireLayerH,
								133);
						PlayState.map.setTileId(x + 4, y, PlayState.fireLayerH,
								133);
						Core.Items.Item.itemDrop(x + 4, y);
					}
				}
...
>>>>>>> origin/master
		...
		if (PlayState.map.getTileId(x - 1, y, PlayState.boxLayer) == 111) {
			...
			hitWallLeft = true;
				...
				&& blastRadius >= 2 && hitWallLeft != true
				&& hitBoxLeft != true) {
			PlayState.map.setTileId(x - 2, y, PlayState.boxLayer, 0);
			PlayState.map.setTileId(x - 1, y, PlayState.fireLayerH, 133);
			PlayState.map.setTileId(x - 2, y, PlayState.fireLayerH, 133);
			...
			hitWallLeft = true;
				...
				&& blastRadius >= 3 && hitWallLeft != true
				&& hitBoxLeft != true) {
			PlayState.map.setTileId(x - 3, y, PlayState.boxLayer, 0);
			PlayState.map.setTileId(x - 1, y, PlayState.fireLayerH, 133);
			PlayState.map.setTileId(x - 2, y, PlayState.fireLayerH, 133);
			...
			hitWallLeft = true;
				...
				&& blastRadius == 4 && hitWallLeft != true
				&& hitBoxLeft != true) {
			PlayState.map.setTileId(x - 4, y, PlayState.boxLayer, 0);
			PlayState.map.setTileId(x - 1, y, PlayState.fireLayerH, 133);
			PlayState.map.setTileId(x - 2, y, PlayState.fireLayerH, 133);
		...
		if (PlayState.map.getTileId(x - 1, y, PlayState.boxLayer) == 0
			...
			if (PlayState.map.getTileId(x - 2, y, PlayState.boxLayer) == 0
					&& blastRadius >= 2 && hitWallLeft1 != true) {
				PlayState.map.setTileId(x - 1, y, PlayState.fireLayerH, 133);
<<<<<<< HEAD
				PlayState.map.setTileId(x - 2, y, PlayState.fireLayerH, 133);
				Core.Items.Item.itemDrop(x - 2, y);
				...
				if (PlayState.map.getTileId(x - 3, y, PlayState.boxLayer) == 0
						&& blastRadius >= 3 && hitWallLeft1 != true) {
					PlayState.map
							.setTileId(x - 1, y, PlayState.fireLayerH, 133);
					PlayState.map
							.setTileId(x - 2, y, PlayState.fireLayerH, 133);
...
>>>>>>> origin/master
					...
					if (PlayState.map.getTileId(x - 4, y, PlayState.boxLayer) == 0
							&& blastRadius == 4 && hitWallLeft1 != true) {
						PlayState.map.setTileId(x - 1, y, PlayState.fireLayerH,
								133);
						PlayState.map.setTileId(x - 2, y, PlayState.fireLayerH,
								133);
...
<<<<<<< HEAD
		...
		if (PlayState.map.getTileId(x, y + 1, PlayState.boxLayer) == 111) {
		...
		} else if (PlayState.map.getTileId(x, y + 1, PlayState.wallLayer) == 18
				|| PlayState.map.getTileId(x, y + 1, PlayState.wallLayer) == 98) {
			hitWallDown = true;
		} else if (PlayState.map.getTileId(x, y + 2, PlayState.boxLayer) == 111
				&& blastRadius >= 2 && hitWallDown != true
				&& hitBoxDown != true) {
			...
			hitWallDown = true;
		} else if (PlayState.map.getTileId(x, y + 3, PlayState.boxLayer) == 111
				&& blastRadius >= 3 && hitWallDown != true
				&& hitBoxDown != true) {
			...
			hitWallDown = true;
		} else if (PlayState.map.getTileId(x, y + 4, PlayState.boxLayer) == 111
				&& blastRadius == 4 && hitWallDown != true
				&& hitBoxDown != true) {
		...
		// If no boxes within blast radius range
		if (PlayState.map.getTileId(x, y + 1, PlayState.wallLayer) == 18
				|| PlayState.map.getTileId(x, y + 1, PlayState.wallLayer) == 98) {
			hitWallDown1 = true;
		}
...
=======
			...
			if (PlayState.map.getTileId(x, y + 1, PlayState.boxLayer) == 111) {
				...
				PlayState.map.setTileId(x, y + 1, PlayState.fireLayerV, 143);
				hitBoxDown = true;
				Core.Items.Item.itemDrop(x ,y + 1, p.bombLength, p.bombsActive);
			}
				...
				PlayState.map.setTileId(x, y + 2, PlayState.fireLayerV, 143);
				hitBoxDown = true;
				Core.Items.Item.itemDrop(x ,y + 2, p.bombLength, p.bombsActive);
			}
			else if(PlayState.map.getTileId(x, y + 2, PlayState.wallLayer) == 98){
				hitWallDown = true;
			}
				...
				PlayState.map.setTileId(x, y + 3, PlayState.fireLayerV, 143);
				hitBoxDown = true;
				Core.Items.Item.itemDrop(x ,y + 3, p.bombLength, p.bombsActive);
			}
			else if(PlayState.map.getTileId(x, y + 3, PlayState.wallLayer) == 98){
				hitWallDown = true;
			}
				...
				PlayState.map.setTileId(x, y + 3, PlayState.fireLayerV, 143);
				PlayState.map.setTileId(x, y + 4, PlayState.fireLayerV, 143);
				Core.Items.Item.itemDrop(x ,y + 4, p.bombLength, p.bombsActive);
			}
			//If no boxes within blast radius range		
...
>>>>>>> origin/master
			...
			if (PlayState.map.getTileId(x, y + 2, PlayState.boxLayer) == 0
					&& blastRadius >= 2 && hitWallDown1 != true) {
				PlayState.map.setTileId(x, y + 1, PlayState.fireLayerV, 143);
<<<<<<< HEAD
				PlayState.map.setTileId(x, y + 2, PlayState.fireLayerV, 143);
				Core.Items.Item.itemDrop(x, y + 2);
...
>>>>>>> origin/master
				...
				if (PlayState.map.getTileId(x, y + 3, PlayState.boxLayer) == 0
						&& blastRadius >= 3 && hitWallDown1 != true) {
					PlayState.map
							.setTileId(x, y + 1, PlayState.fireLayerV, 143);
					PlayState.map
							.setTileId(x, y + 2, PlayState.fireLayerV, 143);
					PlayState.map
							.setTileId(x, y + 3, PlayState.fireLayerV, 143);
					Core.Items.Item.itemDrop(x, y + 3);
...
<<<<<<< HEAD
					...
					if (PlayState.map.getTileId(x, y + 4, PlayState.boxLayer) == 0
							&& blastRadius == 4 && hitWallDown1 != true) {
						PlayState.map.setTileId(x, y + 1, PlayState.fireLayerV,
								143);
						PlayState.map.setTileId(x, y + 2, PlayState.fireLayerV,
								143);
						PlayState.map.setTileId(x, y + 3, PlayState.fireLayerV,
								143);
						PlayState.map.setTileId(x, y + 4, PlayState.fireLayerV,
								143);
						Core.Items.Item.itemDrop(x, y + 4);
					}
				}
...
>>>>>>> origin/master
		...
		if (PlayState.map.getTileId(x, y - 1, PlayState.boxLayer) == 111) {
			...
			hitWallUp = true;
				...
				&& blastRadius >= 2 && hitWallUp != true && hitBoxUp != true) {
			PlayState.map.setTileId(x, y - 2, PlayState.boxLayer, 0);
			PlayState.map.setTileId(x, y - 1, PlayState.fireLayerV, 143);
			PlayState.map.setTileId(x, y - 2, PlayState.fireLayerV, 143);
			hitBoxUp = true;
			...
			hitWallUp = true;
				...
				&& blastRadius >= 3 && hitWallUp != true && hitBoxUp != true) {
			PlayState.map.setTileId(x, y - 3, PlayState.boxLayer, 0);
			PlayState.map.setTileId(x, y - 1, PlayState.fireLayerV, 143);
			PlayState.map.setTileId(x, y - 2, PlayState.fireLayerV, 143);
			PlayState.map.setTileId(x, y - 3, PlayState.fireLayerV, 143);
			...
			hitWallUp = true;
				...
				&& blastRadius == 4 && hitWallUp != true && hitBoxUp != true) {
			PlayState.map.setTileId(x, y - 4, PlayState.boxLayer, 0);
			PlayState.map.setTileId(x, y - 1, PlayState.fireLayerV, 143);
			PlayState.map.setTileId(x, y - 2, PlayState.fireLayerV, 143);
			PlayState.map.setTileId(x, y - 3, PlayState.fireLayerV, 143);
...
>>>>>>> origin/master
	...
	/**
	 * Remove Fire method: Removes the fire blast in the image (game board) 1
	 * second after it has been applied. It is called in explodeBomb() method.
	 * The timer uses the same algorithm as in timerBomb() though it has its own
	 * timerDifFire variable which is the current time, when the method is
	 * called. If the 1 second passes the method runs two for-loops, which goes
	 * goes through the image in the length of 22x13. It checks for each tile if
	 * its ID fits either 123 (four-way fire), 143 (vertical fire), and/or 133
	 * (horizontal fire), and set its ID to 122 (a value not used) to remove
	 * them.
	 * 
	 */
			...
			for (int i = 0; i < 22; i++) {
				for (int j = 0; j < 13; j++) {
					...
					if (PlayState.map.getTileId(i, j, PlayState.fireLayerV) == 143) {
						PlayState.map
								.setTileId(i, j, PlayState.fireLayerV, 122);
					}
					if (PlayState.map.getTileId(i, j, PlayState.fireLayerH) == 133) {
						PlayState.map
								.setTileId(i, j, PlayState.fireLayerH, 122);
					}
				}
			}
			isExploded = true;
